...
INSERT INTO "SHIPMENT" ("ORDERID", "SHIPMENTNUMBER", "USERID", "PLACEDON", "METHOD", "ADDRESS", "STATUS") VALUES
(1, '1', 1, '2020-06-05', 'EXPRESS', '123 TEST', 'DELIVERED');

INSERT INTO "PAYMENTMETHOD" ("USERID", "TYPE", "CARDNUMBER", "NAME", "VALIDUNTIL", "CVC")
(SELECT U.USERID, 'Visa', '1234567890123456', 'Rene Cruces Rios', '2023-06-01', '123'
FROM USERS U
LEFT JOIN "PAYMENTMETHOD" P ON P.USERID = U.USERID
WHERE U.EMAIL = 'rene.cruces@outlook.com' AND P.PAYMENTMETHODID IS NULL);
